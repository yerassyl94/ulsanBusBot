...
public class ConfigureWidget1 extends Activity implements OnItemClickListener {
    ...
    private String TAG = ("[ConfigureWidget1]" + getClass().getSimpleName());
    ...
    /* renamed from: com.neighbor.ulsanbus.ui.ConfigureWidget1$1 */
    class C02621 implements OnClickListener {
        C02621() {
        }

        public void onClick(View arg0) {
            Intent intent = new Intent(ConfigureWidget1.this, FourByOneCellWidgetProvider.class);
            intent.putExtra("appWidgetId", ConfigureWidget1.this.widgetId);
            ConfigureWidget1.this.setResult(0, intent);
            ConfigureWidget1.this.finish();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mContext = this;
        Log.d("ConfigureWidget1", "[[[[[[[ sdkver: " + VERSION.SDK_INT + "]]]]]");
        ...
        if (favoriteCursor.getCount() > 0) {
            ...
            this.mCancelBtn.setOnClickListener(new C02621());
            return;
        }
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        value.put("remain_time", "");
        getContentResolver().insert(DataConst.CONTENT_WIDGET1_URI, value);
        OneCellWidgetProvider.updateWidget(this.mContext, AppWidgetManager.getInstance(this.mContext), this.widgetId);
