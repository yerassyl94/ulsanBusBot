...
final class DecodedBitStreamParser {
    ...
    static DecoderResult decode(byte[] bytes, Version version, ErrorCorrectionLevel ecLevel, Hashtable hints) throws FormatException {
        ...
        return new DecoderResult(bytes, stringBuffer, byteSegments, str);
    }

    private static void decodeHanziSegment(BitSource bits, StringBuffer result, int count) throws FormatException {
