...
final class FieldParser {
    ...
    static String parseFieldsInGeneralPurpose(String rawInformation) throws NotFoundException {
        ...
        while (i < TWO_DIGIT_DATA_LENGTH.length) {
            if (!TWO_DIGIT_DATA_LENGTH[i][0].equals(firstTwoDigits)) {
                i++;
            } else if (TWO_DIGIT_DATA_LENGTH[i][1] == VARIABLE_LENGTH) {
        ...
        while (i < THREE_DIGIT_DATA_LENGTH.length) {
            if (!THREE_DIGIT_DATA_LENGTH[i][0].equals(firstThreeDigits)) {
                i++;
            } else if (THREE_DIGIT_DATA_LENGTH[i][1] == VARIABLE_LENGTH) {
        ...
        while (i < THREE_DIGIT_PLUS_DIGIT_DATA_LENGTH.length) {
            if (!THREE_DIGIT_PLUS_DIGIT_DATA_LENGTH[i][0].equals(firstThreeDigits)) {
                i++;
            } else if (THREE_DIGIT_PLUS_DIGIT_DATA_LENGTH[i][1] == VARIABLE_LENGTH) {
        ...
        while (i < FOUR_DIGIT_DATA_LENGTH.length) {
            if (!FOUR_DIGIT_DATA_LENGTH[i][0].equals(firstFourDigits)) {
                i++;
            } else if (FOUR_DIGIT_DATA_LENGTH[i][1] == VARIABLE_LENGTH) {
    ...
    private static String processFixedAI(int aiSize, int fieldSize, String rawInformation) throws NotFoundException {
        ...
        return '(' + ai + ')' + rawInformation.substring(aiSize, aiSize + fieldSize) + parseFieldsInGeneralPurpose(rawInformation.substring(aiSize + fieldSize));
    }
    ...
    private static String processVariableAI(int aiSize, int variableFieldSize, String rawInformation) throws NotFoundException {
        ...
        return '(' + ai + ')' + rawInformation.substring(aiSize, maxSize) + parseFieldsInGeneralPurpose(rawInformation.substring(maxSize));
    }
}
