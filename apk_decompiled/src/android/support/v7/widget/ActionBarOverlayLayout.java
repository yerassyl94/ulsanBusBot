...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0171R.attr.actionBarSize, 16842841};
    ...
    class C01823 implements Runnable {
        C01823() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C01801();
        this.mRemoveActionBarHideOffset = new C01812();
        this.mAddActionBarHideOffset = new C01823();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0171R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0171R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0171R.id.action_bar));
        }
    }
