...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01983 implements OnFocusChangeListener {
        C01983() {
        }
    ...
    class C01994 implements OnLayoutChangeListener {
        C01994() {
        }
    ...
    class C02005 implements OnClickListener {
        C02005() {
        }
    ...
    class C02016 implements OnKeyListener {
        C02016() {
        }
    ...
    class C02027 implements OnEditorActionListener {
        C02027() {
        }
    ...
    class C02038 implements OnItemClickListener {
        C02038() {
        }
    ...
    class C02049 implements OnItemSelectedListener {
        C02049() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C02051 implements ClassLoaderCreator<SavedState> {
            C02051() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0171R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C02061();
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0171R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C01961();
        this.mReleaseCursorRunnable = new C01972();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02005();
        this.mTextKeyListener = new C02016();
        this.mOnEditorActionListener = new C02027();
        this.mOnItemClickListener = new C02038();
        this.mOnItemSelectedListener = new C02049();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0171R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0171R.styleable.SearchView_layout, C0171R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0171R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0171R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0171R.id.search_plate);
        this.mSubmitArea = findViewById(C0171R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0171R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0171R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0171R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0171R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0171R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0171R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0171R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0171R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0171R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0171R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0171R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0171R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0171R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0171R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0171R.styleable.SearchView_suggestionRowLayout, C0171R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0171R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01983());
        setIconifiedByDefault(a.getBoolean(C0171R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0171R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0171R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0171R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0171R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0171R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0171R.styleable.SearchView_android_focusable, true));
        a.recycle();
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C01994());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0171R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0171R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0171R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0171R.dimen.abc_dropdownitem_text_padding_left) : 0;
