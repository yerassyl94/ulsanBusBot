...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04491();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04502();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C04303();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C04303 implements ViewPropertyAnimatorUpdateListener {
        C04303() {
        }
    ...
    class C04491 extends ViewPropertyAnimatorListenerAdapter {
        C04491() {
        }
    ...
    class C04502 extends ViewPropertyAnimatorListenerAdapter {
        C04502() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0171R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0171R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0171R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0171R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0171R.styleable.ActionBar, C0171R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0171R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0171R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0171R.attr.actionBarWidgetTheme, outValue, true);
