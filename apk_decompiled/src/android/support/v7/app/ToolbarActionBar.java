...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C04292();
    private final Runnable mMenuInvalidator = new C01701();
    ...
    class C04292 implements OnMenuItemClickListener {
        C04292() {
        }
