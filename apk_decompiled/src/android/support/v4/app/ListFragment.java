...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00432();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00421();
    ...
    class C00432 implements OnItemClickListener {
        C00432() {
        }
