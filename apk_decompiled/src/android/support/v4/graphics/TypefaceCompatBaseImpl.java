...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C04011 implements StyleExtractor<FontInfo> {
        C04011() {
        }
    ...
    class C04022 implements StyleExtractor<FontFileResourceEntry> {
        C04022() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C04011());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C04022());
    }
