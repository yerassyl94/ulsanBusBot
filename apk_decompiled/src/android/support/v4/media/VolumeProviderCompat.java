...
public abstract class VolumeProviderCompat {
    ...
    class C04111 implements Delegate {
        C04111() {
        }
    ...
    public Object getVolumeProvider() {
        if (this.mVolumeProviderObj == null && VERSION.SDK_INT >= 21) {
            this.mVolumeProviderObj = VolumeProviderCompatApi21.createVolumeProvider(this.mControlType, this.mMaxVolume, this.mCurrentVolume, new C04111());
        }
